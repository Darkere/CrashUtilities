...
public class FindLoadedTEsCommand implements Command<CommandSourceStack> {
    ...
    private static final SuggestionProvider<CommandSourceStack> sugg = (ctx, builder) -> SharedSuggestionProvider.suggestResource(BuiltInRegistries.BLOCK_ENTITY_TYPE.keySet(), builder);
